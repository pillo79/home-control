...
class ControlDlg : public QWidget
{
	...
	//	QPushButton *mProgEn[24];
		...
		void setBtnStatus(QPushButton *pb, bool force, bool state, ButtonColor mode = bcAuto, QString forced="", QString automatic="", QString off="", bool disable=false, QString disabled="");
		void setBtnStatus3Way(QPushButton *pb, bool force, bool state1, bool state2, ButtonColor mode, QString force1, QString force2, QString auto1, QString auto2, QString off, bool disable=false, QString disabled="");
